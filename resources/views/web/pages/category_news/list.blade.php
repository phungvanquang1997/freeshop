                ...
                <div class="heading">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="itemscope">
                                <a href="http://www.remoingay.com/tin-tuc.html" title="Tin tức"><span itemprop="title">Tin tức</span></a>
                                <ul>
                                    <li><a href="http://www.remoingay.com/tin-tuc/mac-dep.html">Mặc Đẹp</a></li>
                                    <li><a href="http://www.remoingay.com/tin-tuc/xu-huong.html">Xu Hướng</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row news">
                        @foreach ($dataPosts as $dataPostsDetail)
                            ...
                            <div class="col-lg-12 col-md-12 news-item">
                                ...
                                <div class="thumb">
                                    <a href="{{ $dataPostsDetail->slug }}" title="{{ $dataPostsDetail->title }}">
                                        <img src="{{ url($dataPostsDetail->image) }}" alt="{{ $dataPostsDetail->title }}" title="{{ $dataPostsDetail->title }}" />
