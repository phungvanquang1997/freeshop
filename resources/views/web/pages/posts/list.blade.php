                    ...
                    <div class="heading">
                        <div class="breadcrumb">
                            <ul>
                                ...
                                <li itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="itemscope">
                                    <a href="{{ url('tin-tuc' . '/' . $category->slug . '.html') }}" title="Tin tức"><span itemprop="title"><h1>{{ $category->name}}</h1></span></a>                       
                                </li>
                            </ul>
                        </div>
                    </div>                    
                        <div class="news-group clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 news-item">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="tags">
                                                ...
                                                <?php $i++;?>
                                                <a href="{{ url('tin-tuc' . '/tags/' . $dataPostsDetail->id . '-' .\Str::slug($keyword) . '.html') }}">{{$keyword}}</a>
                            ...
                            <div class="paging">
                                <ul class="pagination">                                    
                                    {!! with(new App\ArticleCategoryPaginationLinks($dataPosts))->render() !!}
                                </ul>
                            </div>
                        </div>
                        <!--product-group-->
