<table style="font-size: 14px;table-layout: fixed;border-collapse: collapse;">
	...
	<thead>
		<tr>
			<th colspan="12" align="center" height="25" valign="middle">TỔNG HỢP DOANH SỐ GIAO DỊCH VIÊN</th>
		</tr>
		<tr>
			<th colspan="12" align="center" height="25" valign="middle">Tên giao dịch viên: {{ $user->name }}</th>
		</tr>
		<tr>
