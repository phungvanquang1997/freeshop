<div class="row no-padding filter-container">
    ...
    <div class="form-group">
        <div class="col-sm-2">
            <input name="order" type="text" class=" form-control" value="{{ Input::has('order') ? Input::get('order') : '' }}" placeholder="{{ trans('lang.order_code') }}">
        </div>

        <div class="col-sm-2">
            <input name="transport_code" type="text" class=" form-control" value="{{ Input::has('transport_code') ? Input::get('transport_code') : '' }}" placeholder="{{ trans('lang.transport_code') }}">
        </div>

        <div class="col-sm-2">
            <input name="purchase_codes" type="text" class=" form-control" value="{{ Input::has('purchase_codes') ? Input::get('purchase_codes') : '' }}" placeholder="{{ trans('lang.purchase_code') }}">
        </div>
        ...
        <div class="col-md-1">
            ...
            <!--
            <a href="{{ url('admin/order_shipping/export-sale-by-user/' . Input::get('admin') ) }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> {{ trans('lang.doanh_so') }}</a>
            <a href="{{ url('admin/order_shipping/export-return-money/' ) }}/<?php echo $date;?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> {{ trans('lang.return_of_fee') }}</a>
             <a href="{{ url('admin/order_shipping/export_list_orders/' . $date ) }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Theo d?i ðõn hàng</a>-->
        </div>     
    </div>
