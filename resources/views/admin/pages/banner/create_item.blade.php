...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('admin/banner/' . $banner->id) }}">{{ $banner->name }}</a></li>
...
@section('content')
    <div class="box">
        <div class="box-body">
            ...
            <!-- Form Open -->
            {!! Form::open(['method' => 'POST', 'url' => 'admin/banner/item-store/' . $banner->id, 'class' => 'form-horizontal', 'files' => true]) !!}
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        @include('admin.pages.banner._form_item')
                    </div>
