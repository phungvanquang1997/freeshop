        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-2 pull-right text-right">
                    <a class="btn btn-primary" href="{{ url('admin/banner/create') }}">{{trans('lang.add_new')}}</a>
                </div>
            </div>
                ...
                <tbody>
                    @if (isset($banners))
                        ...
                        <tr>                          
                            ...
                            <td>
                                <a href="{{ url('admin/banner/' . $banner->id ) }}"
                               ...
                               class="btn btn-xs btn-default font14 btn-action" data-toggle="tooltip" title="{{trans('lang.update')}}"><i class="fa fa-pencil"></i></a>
                                {!! Form::open(['method' => 'DELETE', 'url' => 'admin/banner/' . $banner->id, 'class' => 'inline']) !!}
