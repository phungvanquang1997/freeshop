...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('admin/menu/' . $menu->id) }}">{{ $menu->name }}</a></li>
...
@section('content')
    <div class="box">
        <div class="box-body">
            ...
            <form method="POST" action="{{ url('admin/menu/item-store/' . $menu->id) }}" class="form-horizontal">
                @csrf
                @method('POST')
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            @include('admin.pages.menus._form_item')
                        </div>
