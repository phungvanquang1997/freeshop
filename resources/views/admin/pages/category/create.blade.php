...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/category') }}">{{trans('lang.list')}}</a></li>
...
@section('content')
    <div class="box">
        <div class="box-body">
            ...
            <!-- Form Open -->
            {!! Form::open(array_merge(['url' => 'admin/category/article'], ['class' => 'form-horizontal'])) !!}
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="pull-right">
                        {!! App\Helpers\MyHtml::submit(trans('lang.create'), ['class' => 'btn btn-primary']) !!}
                    </li>
