...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/category/article') }}">{{trans('lang.list')}}</a></li>
...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            ...
            <!-- Form Open -->
            {!! Form::open(array_merge(['url' => 'admin/category/article/' . $category->id, 'method' => 'PUT'], ['class' => 'form-horizontal'])) !!}
