...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/category/product') }}">{{trans('lang.list')}}</a></li>
...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            ...
            <!-- Form Open -->
            {!! \Form::open(array_merge(['url' => 'admin/category/product/' . $category->id, 'method' => 'PUT'], ['class' => 'form-horizontal'])) !!}
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        @include('admin.pages.product_category._form', ['category' => $category])
                    </div>
